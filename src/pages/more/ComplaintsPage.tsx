...
import { useAddComplaintMutation } from "../../apis/complaints/queries";
import { ComplaintInputModel } from "../../apis/complaints/type";
import * as Yup from "yup";
import { Formik, FormikHelpers } from "formik";

const ComplaintsPage = () => {
  const { t } = useTranslation();
  const { mutate: addComplaint } = useAddComplaintMutation();
