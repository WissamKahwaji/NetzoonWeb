...
interface CartWebViewProps {
  serviceFee: number;
}
const CartWebView = ({ serviceFee }: CartWebViewProps) => {
  ...
  return (
    <div className="container mx-auto p-4 w-full md:w-3/4 md:mx-auto">
      {cartValues.length !== 0 && (
      ...
      {cartValues.length === 0 ? (
        ...
        <div className="w-full grid grid-cols-2 gap-x-5">
          ...
          <div className=" w-full flex flex-col space-y-5 justify-center items-center px-4 py-5   rounded-lg shadow-xl bg-primary/10">
            <div className="flex flex-row w-full justify-between items-center text-lg text-black font-semibold">
              <p>{t("order_total")}</p>
              <p>
            ...
            <button
              className="w-full flex justify-center items-center py-3 font-bold text-primary rounded-xl bg-transparent border border-primary "
              onClick={() => {
